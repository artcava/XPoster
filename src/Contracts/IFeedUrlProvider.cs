...
/// </summary>
/// <remarks>
/// Decouples feed URL configuration from <see cref="XPoster.Orchestrators.FeedOrchestrator"/> and
/// <see cref="XPoster.Contracts.IFeedService"/> internals, following the same pattern as
