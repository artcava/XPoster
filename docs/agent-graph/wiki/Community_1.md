...
- **AzureFoundryServiceTests.cs** (42 connections)
- **AzureFoundryServiceTests.cs** (42 connections)
...
- **GenerateImageAsync_WhenTimeoutRejectedExceptionOnPost_ReturnsEmptyByteArray()** (2 connections)
...
- **GenerateTextAsync_WhenUsedAsImagePromptDerivationStep_AndChoicesEmpty_ReturnsEmptyString()** (2 connections)
...
- **GenerateTextAsync_RequestBodyContainsModelFromOptions()** (2 connections)
