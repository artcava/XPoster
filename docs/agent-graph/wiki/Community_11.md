...
- **Execute_LinearChain_ExecutesInOrder_AndStoresOutputs()** (2 connections)
- **Execute_Cycle_ReturnsFailure_WithDescriptiveError()** (2 connections)
- **Execute_Diamond_ExecutesAllNodes_AndResolvesDependencies()** (2 connections)
- **Execute_EmptyNodesDefinition_Succeeds()** (2 connections)
...
- **Execute_MissingRef_ReturnsFailure_WithDescriptiveError()** (2 connections)
- **EmptySenders()** (2 connections)

## Relationships

- [[Community 175]] (4 shared connections)
