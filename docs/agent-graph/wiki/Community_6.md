...
- **GenerateTextAsync_ImagePromptRole_WhenChoicesArrayIsEmpty_ReturnsEmptyString()** (2 connections)
- **BuildService()** (2 connections)
- **BuildImagePromptRequest()** (2 connections)
- **MakeHandlerMock()** (2 connections)
- **GenerateTextAsync_WhenTextExceedsMaxOutputLength_CallsApiAndReturnsContent()** (2 connections)
